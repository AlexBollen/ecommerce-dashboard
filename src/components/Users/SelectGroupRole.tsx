...
const SelectGroupRole = ({
  ...
  return (
    <div className="mb-4.5">
      <label className="mb-2.5 block text-white dark:text-white"> Rol </label>
      ...
      <div className="relative z-20 bg-transparent white:bg-form-input">
        ...
        >
          <option value="" disabled className="text-body white:text-bodydark">
            Selecciona el rol
          </option>
          <option value="1" className="text-body white:text-bodydark">
            Administrador
          </option>
          <option value="2" className="text-body white:text-bodydark">
            Gerente
          </option>
        </select>
